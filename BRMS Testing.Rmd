...
now that I have the componentry to perform a BRMS setup with the model. lets call BRMS and ask for the code to see it works.
...
Now that we have created BRMS compatible stancode. Lets try to compile it
...
Readers may note that the BRMS package has effectively been used like a trojan horse to run this code. This shows how much control there is over the BRMS package behaviour if you know how stancode works.
