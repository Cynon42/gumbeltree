...
We can now move on to boosting model, but we will define the basic stan model now as well, fo rthose that don't need or want the hassle of working with BRMS

```{r}

temp = make_stancode(y~to_vector(x1,x2)
              ,data=data.frame(y=c(1,2,3,4),x1=c(1,2,3,4),x2=c(1,2,3,4)))
```
